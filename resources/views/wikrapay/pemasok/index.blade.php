                ...
                <div class="flex-grow-1 card-p pb-0">
                    <div class="d-flex flex-stack flex-wrap">
                        ...
                        <div class="d-flex align-items-center py-1">
                            ...
                            <!--end::Wrapper-->
                            <!--begin::Button-->
                            <a href="{{ route('pemasok.create') }}" class="btn btn-sm btn-primary">Create</a>
                            <!--end::Button-->
                        </div>
                        <!--end::Actions-->
                    </div>
                    ...
                    <table class="table table-responsive table-row-dashed table-row-gray-500 gy-5 gs-5 mb-0">
                        <thead>
                            <tr class="fw-bold fs-4 text-gray-800">
                                ...
                                <th scope="col">No Telephoe</th>
                                <th scope="col">No Jenis</th>
                            ...
                            <tr>
                                ...
                                <td>   
                                    <form action="{{ route('pemasok.destroy', $item->id) }}" method="POST">
                                        ...
                                        <a class="btn btn-info" href="{{ route('pemasok.show',$item->id) }}">
                                        ...
                                        <a class="btn btn-primary" href="{{ route('pemasok.edit', $item->id) }}">
